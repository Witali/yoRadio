 ...
 * Diagnostic 128/192/256-word variants require the PCM queue in CMake.
 * 192 words divides a full 960-sample Opus frame without a partial tail.
...
#endif
#if YORADIO_ESP8266_DMA_BUFFER_WORDS != 128 && YORADIO_ESP8266_DMA_BUFFER_WORDS != 192 && YORADIO_ESP8266_DMA_BUFFER_WORDS != 256 && YORADIO_ESP8266_DMA_BUFFER_WORDS != 512 && YORADIO_ESP8266_DMA_BUFFER_WORDS != 768
#error "DMA buffer words must be diagnostic 128/192/256, 512 or diagnostic 768"
#endif
