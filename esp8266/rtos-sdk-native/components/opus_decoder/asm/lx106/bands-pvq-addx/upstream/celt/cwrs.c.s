...
decode_pulses:
# PVQ ADDX4 overlay: call0 ABI, arguments/return and stack are unchanged.
...
# @OPUS@\upstream\celt\cwrs.c:540:   return cwrsi(_n,_k,ec_dec_uint(_dec,CELT_PVQ_V(_n,_k)),_y);
	...
	mov.n	a3, a13	# _k, _n
.L19:
# PVQ ADDX4: slli	a3, a3, 2 ; add.n	a3, a14, a3 => one exact address operation.
	addx4 a3, a3, a14	# dst = (index << 2) + base, modulo 2^32; shifted temporary dies here.
...
# @OPUS@\upstream\celt\cwrs.c:540:   return cwrsi(_n,_k,ec_dec_uint(_dec,CELT_PVQ_V(_n,_k)),_y);
	...
	mov.n	a4, a13	# _7, _n
.L22:
# PVQ ADDX4: slli	a4, a4, 2 ; add.n	a4, a14, a4 => one exact address operation.
	addx4 a4, a4, a14	# dst = (index << 2) + base, modulo 2^32; shifted temporary dies here.
...
# PVQ ADDX4: slli	a15, a15, 2 ; add.n	a15, a6, a15 => one exact address operation.
# @OPUS@\upstream\celt\cwrs.c:478:       p=row[_k+1];
	addx4 a15, a15, a6	# dst = (index << 2) + base, modulo 2^32; shifted temporary dies here.
...
# PVQ ADDX4: slli	a4, a12, 2 ; add.n	a4, a14, a4 => one exact address operation.
	addx4 a4, a12, a14	# dst = (index << 2) + base, modulo 2^32; shifted temporary dies here.
# @OPUS@\upstream\celt\cwrs.c:499:       p=CELT_PVQ_U_ROW[_k][_n];
	l32i.n	a6, a4, 0	# CELT_PVQ_U_ROW, tmp320
# @OPUS@\upstream\celt\cwrs.c:500:       q=CELT_PVQ_U_ROW[_k+1][_n];
# PVQ ADDX4: slli	a15, a15, 2 ; add.n	a15, a14, a15 => one exact address operation.
	addx4 a15, a15, a14	# dst = (index << 2) + base, modulo 2^32; shifted temporary dies here.
# @OPUS@\upstream\celt\cwrs.c:499:       p=CELT_PVQ_U_ROW[_k][_n];
...
# @OPUS@\upstream\celt\cwrs.c:511:         do p=CELT_PVQ_U_ROW[--_k][_n];
# PVQ ADDX4: slli	a9, a8, 2 ; add.n	a9, a14, a9 => one exact address operation.
	addx4 a9, a8, a14	# dst = (index << 2) + base, modulo 2^32; shifted temporary dies here.
# @OPUS@\upstream\celt\cwrs.c:511:         do p=CELT_PVQ_U_ROW[--_k][_n];
...
# @OPUS@\upstream\celt\cwrs.c:511:         do p=CELT_PVQ_U_ROW[--_k][_n];
	addi	a8, a12, -2	# _k, _k,
# @OPUS@\upstream\celt\cwrs.c:511:         do p=CELT_PVQ_U_ROW[--_k][_n];
# PVQ ADDX4: slli	a4, a8, 2 ; add.n	a4, a14, a4 => one exact address operation.
	addx4 a4, a8, a14	# dst = (index << 2) + base, modulo 2^32; shifted temporary dies here.
# @OPUS@\upstream\celt\cwrs.c:511:         do p=CELT_PVQ_U_ROW[--_k][_n];
