...
# @OPUS@\upstream\celt\vq.c:148:    i=0;
	movi.n	a3, 0	# i,
# Hoisted invariant SAR setup for alg_unquant; no calls/SAR writers in loop.
...
# Hoisted invariant SAR setup for renormalise_vector; no calls/SAR writers in loop.
# Same loads/stores, multiply, rounding, arithmetic shift and final SAR value.
# SDK context save/restore preserves SAR across interrupts; IRQs stay enabled.
	ssr	a5
.L185:
