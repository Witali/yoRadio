# Exact inline n/d, a2=n,a3=d -> a2. Same call0 volatile registers/SAR.
...
y_div_inline_\id\()_begin:
	movi a4,256
	bltu a4,a3,.Ly_inline_slow\@
	beqz a3,.Ly_inline_slow\@
	beqi a3,1,.Ly_inline_done\@
	neg a4,a3
	and a4,a4,a3
	nsau a4,a4
	movi a5,31
...
# @OPUS@\upstream\celt\entdec.c:95:   return _this->offs<_this->storage?_this->buf[_this->offs++]:0;
	...
	.literal_position
	.literal .Ly_inline_table, yoradio_opus_small_div_table
	.align	4
	.global	ec_decode
