# Folding scale: a14=N0, a2=N0<<22 already formed by the caller.
...
# @OPUS@\upstream\celt\bands.c:760:    tell = ec_tell_frac(ec);
	l32i.n	a2, sp, 20	# %sfp,
	Y_OPUS_TELL_FRAC	# Exact inlining; original call0 ABI and state.
	mov.n	a11, a2	# _134,
...
# @OPUS@\upstream\celt\bands.c:1123: }
	...
	.literal_position
	.literal .Lfold8_table, yoradio_opus_folding8_table
	.literal .LC14, 16384
	.literal .LC15, -16384
	.literal .LC16, 23170
...
# Values computed by the pinned original fixed-point sqrt.
	.section .rodata.yoradio_opus_folding8_table,"a",@progbits
	.balign 4
	.type yoradio_opus_folding8_table,@object
yoradio_opus_folding8_table:
	.word 0
	.word 5793
	.word 8194
	.word 10033
	...
	.word 26539
	.word 27163
	.size yoradio_opus_folding8_table,.-yoradio_opus_folding8_table
