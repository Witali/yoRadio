...
Следующее дополнение: [исходные RC-PDM и Simple без dither/feedback/интерполяции](../esp8266-rcpdm-6144-legacy-2026-09-06/README.md)
на той же частоте, с сохранением всех пяти контрольных вариантов этого отчёта.
