...
const {root}=require('./export.cjs'),f=require('./bits_fourth.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-bits-fourth-board'),read=f.read;
