...
const {root}=require('./export.cjs'),f=require('./ebands_more.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-ebands-more-board-20260917'),read=f.read;
function report(){
