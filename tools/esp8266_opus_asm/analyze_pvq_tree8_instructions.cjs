...
const {root,hash,sourceHash}=require('./export.cjs'),f=require('./pvq_tree8.cjs'),sem=require('./pvq_tree8_proof.cjs'),base=require('./frozen_reloads.cjs');
function analyze(){
 ...
 const prefix=f.read(path.join(root,'docs/benchmarks/esp8266-opus-pvq-prefix-2026-09-19/summary.json'));
