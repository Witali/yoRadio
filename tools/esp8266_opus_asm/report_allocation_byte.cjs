...
const {root}=require('./export.cjs'),f=require('./allocation_byte.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-allocation-byte-board-20260917'),read=f.read;
function report(){
