...
const {root}=require('./export.cjs'),f=require('./micro_bundle.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-micro-bundle-board'),read=f.read;
