...
const {root}=require('./export.cjs'),f=require('./bits_fifth.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-bits-fifth-board'),read=f.read;
