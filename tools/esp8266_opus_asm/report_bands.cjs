...
function report(kind){
 assert.ok(['intensity','blocks'].includes(kind));
 ...
 const identity=['opus_backend','opus_asm_optimization_sha256','opus_bands_blocks_manifest_sha256','built_utc','source_revision','app_sha256','bytes'];
 ...
 const selected=kind==='blocks'?mb.opus_bands_blocks_manifest_sha256:mb.opus_asm_optimization_sha256;
