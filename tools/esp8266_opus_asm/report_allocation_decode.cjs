...
const {root}=require('./export.cjs'),f=require('./allocation_decode.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-allocation-decode-board-20260918');
function report(){
