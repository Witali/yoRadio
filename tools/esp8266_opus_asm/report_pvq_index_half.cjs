...
const {root}=require('./export.cjs'),f=require('./pvq_index_half.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-pvq-index-half-board'),read=f.read;
