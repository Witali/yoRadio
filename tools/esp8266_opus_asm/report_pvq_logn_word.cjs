...
const {root}=require('./export.cjs'),f=require('./pvq_logn_word.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-pvq-logn-word-board'),read=f.read;
