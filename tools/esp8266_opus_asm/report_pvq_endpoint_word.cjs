...
const {root}=require('./export.cjs'),f=require('./pvq_endpoint_word.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-pvq-endpoint-word-board'),read=f.read;
