...
const {root}=require('./export.cjs'),f=require('./endpoint_cost.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-endpoint-cost-board'),read=f.read;
