...
const {root}=require('./export.cjs'),f=require('./pvq_row_word.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-pvq-row-word-board'),read=f.read;
