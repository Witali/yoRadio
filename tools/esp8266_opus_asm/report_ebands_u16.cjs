...
const {root}=require('./export.cjs'),f=require('./ebands_u16.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-ebands-u16-board-20260917'),read=f.read;
function report(){
