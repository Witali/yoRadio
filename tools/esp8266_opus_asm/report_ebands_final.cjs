...
const {root}=require('./export.cjs'),f=require('./ebands_final.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-ebands-final-board-20260917'),read=f.read;
function report(){
