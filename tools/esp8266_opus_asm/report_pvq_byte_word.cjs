...
const {root}=require('./export.cjs'),f=require('./pvq_byte_word.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-pvq-byte-word-board'),read=f.read;
