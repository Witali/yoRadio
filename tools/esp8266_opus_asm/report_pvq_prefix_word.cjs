...
const {root}=require('./export.cjs'),f=require('./pvq_prefix_word.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-pvq-prefix-word-board-20260919');
