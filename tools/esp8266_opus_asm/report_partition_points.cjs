...
const {root}=require('./export.cjs'),f=require('./partition_points.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-partition-points-board'),read=f.read;
