...
async function check(kind){
 ...
 if(kind==='cache-reuse'||kind==='inner4'||kind==='logp'||kind==='tell-inline'||kind==='small-div'||kind==='folding8'||kind==='partition-decode'||kind==='ec-bits'||kind==='micro-bundle'||kind==='pvq-dim-pointer'||kind==='partition-points'||kind==='bits-fifth'||kind==='bits-fourth'||kind==='endpoint-cost'||kind==='pvq-byte-word'||kind==='pvq-a4-word'||kind==='pvq-row-word'||kind==='pvq-endpoint-word'||kind==='pvq-index-word'){
 ...
 if(kind==='partition-decode'||kind==='ec-bits'||kind==='micro-bundle'||kind==='pvq-dim-pointer'||kind==='partition-points'||kind==='bits-fifth'||kind==='bits-fourth'||kind==='endpoint-cost'||kind==='pvq-byte-word'||kind==='pvq-a4-word'||kind==='pvq-row-word'||kind==='pvq-endpoint-word'||kind==='pvq-index-word'){
