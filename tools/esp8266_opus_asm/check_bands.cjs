...
async function check(kind){
 ...
 if(kind==='cache-reuse'||kind==='inner4'||kind==='logp'||kind==='tell-inline'||kind==='small-div'||kind==='folding8'||kind==='partition-decode'||kind==='ec-bits'||kind==='micro-bundle'||kind==='pvq-dim-pointer'||kind==='partition-points'||kind==='bits-fifth'||kind==='bits-fourth'||kind==='endpoint-cost'||kind==='pvq-byte-word'||kind==='pvq-a4-word'||kind==='pvq-row-word'||kind==='pvq-endpoint-word'||kind==='pvq-index-word'||kind==='pvq-index-half'||kind==='pvq-logn-word'||kind==='pvq-exp2-word'||kind==='pvq-exp2-table32'||kind==='pvq-qn-table'||kind==='ebands-pair'||kind==='ebands-more'||kind==='allocation-byte'||kind==='ebands-final'||kind==='ebands-u16'||kind==='ebands-u16-aligned'||kind==='ebands-quant'||kind==='ebands-src'||kind==='allocation-decode'||kind==='quant-decode'||kind==='quant-flags'||kind==='quant-locals'||kind==='pvq-binary'||kind==='pvq-tree8'){
 ...
 if(kind==='partition-decode'||kind==='ec-bits'||kind==='micro-bundle'||kind==='pvq-dim-pointer'||kind==='partition-points'||kind==='bits-fifth'||kind==='bits-fourth'||kind==='endpoint-cost'||kind==='pvq-byte-word'||kind==='pvq-a4-word'||kind==='pvq-row-word'||kind==='pvq-endpoint-word'||kind==='pvq-index-word'||kind==='pvq-index-half'||kind==='pvq-logn-word'||kind==='pvq-exp2-word'||kind==='pvq-exp2-table32'||kind==='pvq-qn-table'||kind==='ebands-pair'||kind==='ebands-more'||kind==='allocation-byte'||kind==='ebands-final'||kind==='ebands-u16'||kind==='ebands-u16-aligned'||kind==='ebands-quant'||kind==='ebands-src'||kind==='allocation-decode'||kind==='quant-decode'||kind==='quant-flags'||kind==='quant-locals'||kind==='pvq-binary'||kind==='pvq-tree8'){
