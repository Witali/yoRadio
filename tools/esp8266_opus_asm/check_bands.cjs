...
async function check(kind){
 ...
 const report={scope:'Host semantic mirror, exact PCM/guards; not LX106 execution or timing',kind,recipe_sha256_lf:sourceHash(path.join(__dirname,kind==='blocks'?'blocks.cjs':'bands.cjs')),cases:[]};
