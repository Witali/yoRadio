...
const {root}=require('./export.cjs'),f=require('./ebands_pair.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-ebands-pair-board-20260917'),read=f.read;
function report(){
