...
const {root}=require('./export.cjs'),f=require('./pvq_exp2_word.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-pvq-exp2-word-board'),read=f.read;
