...
const {root}=require('./export.cjs'),f=require('./ebands_quant.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-ebands-quant-board-20260918'),read=f.read;
function report(){
