...
const {root}=require('./export.cjs'),f=require('./pvq_exp2_table32.cjs');
...
const dest=f.art('candidate'),experiment=path.join(root,'.build/opus-pvq-exp2-table32-board'),read=f.read;
