...
function build(directory,stem='rcpdm8_quality') {
  if(!['rcpdm8_quality','rcpdm_precision','rcpdm_simple_quality','pdm_matrix_quality','rcpdm_feedback_quality','rcpdm_feedback_ab','rcpdm_6144_quality'].includes(stem)) throw Error('Unknown benchmark source');
