...
function audit({before='.build/esp8266-opus-block-live',off='.build/esp8266-opus-stage-off',on='.build/esp8266-opus-stage-bands',output='.build/opus-stage-target.json'}={}) {
