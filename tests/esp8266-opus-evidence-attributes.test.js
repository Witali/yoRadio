...
test('new memory and qn JSON evidence keeps LF and native logs retain their bytes',()=>{
 for(const dir of['esp8266-opus-live-memory-diag-v1/evidence/runs','esp8266-opus-pvq-qn-table-candidate-v1/qualified/before','esp8266-opus-ebands-pair-candidate-v1/before','esp8266-opus-ebands-more-candidate-v1/before','esp8266-opus-allocation-byte-candidate-v1/before','esp8266-opus-ebands-final-candidate-v1/before']){
...
test('eBands and allocation parent ELF archives are LFS-managed binary',()=>{
 for(const family of ['ebands-pair','ebands-more','allocation-byte','ebands-final']){
