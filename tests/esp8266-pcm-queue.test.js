...
test('actual PCM queue survives concurrent ownership, backpressure, stop and output failure, stack '+stack+' app '+appTask+' slots '+slots,{timeout:60000},t=>{
  ...
  execute('gcc',['-std=c11','-O1','-g','-Wall','-Wextra','-Werror','-pthread',
    ...
    '-DYORADIO_ESP8266_OPUS_PCM_SLOTS='+slots,
