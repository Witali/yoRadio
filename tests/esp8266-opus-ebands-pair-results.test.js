...
const root=path.resolve(__dirname,'..'),dir='firmware/development/esp8266-opus-ebands-pair-candidate-v1';
...
test('eBands experiment restores the previous ordinary image with saved settings and playlist',()=>{
