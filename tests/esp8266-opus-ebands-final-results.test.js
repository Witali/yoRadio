...
const root=path.resolve(__dirname,'..'),dir='firmware/development/esp8266-opus-ebands-final-candidate-v2';
...
test('ebands-final A/B/A recomputes every raw trial and the unrounded75% gate',()=>{
...
test('Additional ebands-final experiment restores the previous ordinary image with saved settings and playlist',()=>{
