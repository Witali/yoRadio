...
const root=path.resolve(__dirname,'..'),dir='firmware/development/esp8266-opus-allocation-byte-candidate-v1';
...
test('allocation-byte A/B/A recomputes every raw trial and the unrounded75% gate',()=>{
...
test('Additional allocation-byte experiment restores the previous ordinary image with saved settings and playlist',()=>{
