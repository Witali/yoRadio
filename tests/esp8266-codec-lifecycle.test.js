...
test('real codec bridge and arena pair every allocation/free through OOM and switches' +
  (opusEnabled ? ' with Opus input ' + opusInput + ', scratch ' + opusScratch + ', diagnostics ' + diagnostics + ', PCM queue ' + pcmQueue : ' with Opus disabled'), t => {
  ...
  const defines=['YORADIO_ESP8266_NATIVE=1','YORADIO_HELIX_MP3_MONO=1','YORADIO_HELIX_MP3_SSO=1',
    ...
    'YORADIO_ESP8266_OPUS_BENCHMARK=0', 'YORADIO_OPUS_PCM_LEASES='+pcmQueue,
    'YORADIO_ESP8266_OPUS_PCM_QUEUE='+pcmQueue, 'PROGMEM='];
