...
const ScrollConfig metaConf       PROGMEM = {{ 0, 0, 1, WA_LEFT }, 96, true, 72, 3500, 1, 35 };
const ScrollConfig title1Conf     PROGMEM = {{ 0, 10, 1, WA_LEFT }, 140, true, 54, 3500, 1, 35 };
...
const FillConfig metaBGConf       PROGMEM = {{ 0, 0, 0, WA_LEFT }, 72, 9, false };
...
const WidgetConfig iptxtConf      PROGMEM = { 0, 32, 1, WA_LEFT };
